...
- Flutter & Dart  
- Bloc / Riverpod  
- Firebase (Auth, Firestore, Messaging) or custom backend in express.js
- REST APIs  
- Custom widgets, animations  
- Offline-first data and clean architecture

## 📬 Contact
If you want to discuss a project or need help with something Flutter or full-stack:
...
<!--
**garrenc/garrenc** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
